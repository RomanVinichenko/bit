                     ...
                     <div className='trade-like-pro-flex'>
                        <div className='trade-like-pro-left'>
                           ...
                           <div className='trade-like-pro-item'>
                              ...
                              <span className='trade-like-pro-item-small-text-3_3'>{t('premiumSupport')}</span>
                           </div>
            ...
            <section className="partner-section">
               <div className="container-parent">
                  ...
                  <div className="partner-row">
                     ...
                     <img src={galaxy_digital} className="partner-row-img" style={{marginLeft: '7px'}} alt="" />
            ...
            <section className="subscribe-section">
               ...
               <div className="container-parent">
                  ...
                  <div className='subscribe-form-item'>
                     ...
                     <input type="email" value={emailValue2} onChange={e => setEmailValue2(e.target.value)} className="form-input" placeholder={t('enterEmailAddress')} />
